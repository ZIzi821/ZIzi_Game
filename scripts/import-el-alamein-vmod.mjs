...
const HIGH_GROUND_HEX_IDS = [
  "c08r00",
  "c08r08", "c09r08", "c10r08", "c11r08", "c12r08", "c13r08",
  "c06r12", "c07r12", "c10r12", "c11r12",
  "c10r15", "c11r16", "c12r16",
  "c05r19", "c06r19", "c08r19", "c09r19",
  "c15r11", "c16r11",
  "c17r10", "c18r09", "c18r10", "c19r09",
];

const BRITISH_POSITION_HEX_IDS = [
  "c08r00",
  "c09r02", "c10r04", "c10r05", "c10r07", "c10r08",
  "c09r09", "c09r11", "c10r13", "c15r07",
  "c17r10", "c18r10", "c21r08",
];

const SETTLEMENT_HEX_IDS = [
  "c12r03",
  "c24r04",
];

const COASTAL_ROAD_HEX_IDS = [
  "c09r03", "c10r03", "c11r03", "c12r03",
  "c13r04", "c14r04", "c15r04", "c16r04",
  "c17r04", "c18r04", "c19r04", "c20r04",
  "c21r04", "c22r04", "c23r04", "c24r04",
  "c25r03", "c26r02",
];

const ALAM_HALFA_OBJECTIVE_HEX_IDS = [
  "c17r10",
  "c18r10",
];
...
function generateHexes(hexGrid, zonePath) {
  ...
  markById(hexes, HIGH_GROUND_HEX_IDS, (hex) => {
    if (hex.terrain !== "mediterranean") hex.terrain = "highland";
  });
  markById(hexes, SETTLEMENT_HEX_IDS, (hex) => {
    if (hex.terrain !== "mediterranean") hex.terrain = "settlement";
  });
  markById(hexes, BRITISH_POSITION_HEX_IDS, (hex) => {
    if (hex.terrain !== "mediterranean") hex.britishPosition = true;
  });
  markById(hexes, COASTAL_ROAD_HEX_IDS, (hex) => {
    if (hex.terrain !== "mediterranean") hex.road = true;
  });
  markById(hexes, ALAM_HALFA_OBJECTIVE_HEX_IDS, (hex) => {
  ...
  markById(hexes, COASTAL_ROAD_HEX_IDS.filter((id) => {
    const hex = hexes.find((candidate) => candidate.id === id);
    return hex && hex.col >= 12;
  }), (hex) => {
...
function markById(hexes, ids, apply) {
